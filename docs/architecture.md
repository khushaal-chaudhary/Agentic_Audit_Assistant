...
- Uploaded dossiers and the SQLite evidence ledger live under ignored `data/runtime`.
...
- Send only selected passages to OpenAI/Cognee, never an entire ledger export.
